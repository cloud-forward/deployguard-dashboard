 ...
 */
import type { AssetInventoryItemResponseDetails } from './assetInventoryItemResponseDetails';
import type { AssetStatusResponse } from './assetStatusResponse';

export interface AssetInventoryItemResponse {
  asset_id: string;
  asset_type: string;
  name: string;
  cluster_id: string;
  ...
  details?: AssetInventoryItemResponseDetails;
}
