 ...
 */
import type { AttackGraphEdgeResponseMetadata } from './attackGraphEdgeResponseMetadata';
import type { AttackGraphEdgeType } from './attackGraphEdgeType';

export interface AttackGraphEdgeResponse {
  ...
  /** Target node id */
  target: string;
  /** uses | bound_to | grants | escapes_to | assumes | accesses | allows | runs */
  type: AttackGraphEdgeType;
  /** Additional edge metadata */
  metadata?: AttackGraphEdgeResponseMetadata;
}
