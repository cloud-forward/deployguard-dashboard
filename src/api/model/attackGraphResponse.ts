 ...
 */
import type { AttackGraphEdgeResponse } from './attackGraphEdgeResponse';
import type { AttackGraphNodeResponse } from './attackGraphNodeResponse';
import type { AttackGraphPathResponse } from './attackGraphPathResponse';

export interface AttackGraphResponse {
  /** Cluster id */
  cluster_id: string;
  /** Latest analysis job id backing this graph */
  analysis_run_id?: string | null;
  /** Generation timestamp for the returned graph */
  generated_at?: string | null;
  nodes?: AttackGraphNodeResponse[];
  edges?: AttackGraphEdgeResponse[];
  paths?: AttackGraphPathResponse[];
}
