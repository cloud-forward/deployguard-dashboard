 ...
 */
import type { AnalysisResultStatsFactsResponse } from './analysisResultStatsFactsResponse';
import type { AnalysisResultStatsGraphResponse } from './analysisResultStatsGraphResponse';
import type { AnalysisResultStatsPathsResponse } from './analysisResultStatsPathsResponse';

export interface AnalysisResultStatsResponse {
  facts?: AnalysisResultStatsFactsResponse | null;
  graph?: AnalysisResultStatsGraphResponse | null;
  paths?: AnalysisResultStatsPathsResponse | null;
}
