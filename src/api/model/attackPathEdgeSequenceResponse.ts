 ...
 */
import type { AttackPathEdgeSequenceResponseMetadata } from './attackPathEdgeSequenceResponseMetadata';

export interface AttackPathEdgeSequenceResponse {
  /** Stable persisted edge sequence id */
  edge_id: string;
  /** 0-based edge order within the attack path */
  edge_index: number;
  /** Source node id */
  source_node_id: string;
  /** Target node id */
  target_node_id: string;
  /** Canonical persisted edge type */
  edge_type: string;
  /** Persisted edge metadata */
  metadata?: AttackPathEdgeSequenceResponseMetadata;
}
