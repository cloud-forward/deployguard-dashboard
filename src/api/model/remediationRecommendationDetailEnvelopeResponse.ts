...
export interface RemediationRecommendationDetailEnvelopeResponse {
  /** Cluster id */
  cluster_id: string;
  /** Latest analysis job id backing this recommendation */
  analysis_run_id?: string | null;
  /** Generation timestamp for the returned recommendation */
  generated_at?: string | null;
  /** Requested remediation recommendation detail */
  recommendation?: RemediationRecommendationDetailResponse | null;
}
