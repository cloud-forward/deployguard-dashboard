...
export interface AttackGraphPathResponse {
  /** Stable path identifier */
  id: string;
  /** Backend-provided path title */
  title: string;
  /** Short human-readable path summary */
  summary?: string;
  /** critical | high | medium | low | none */
  severity: AttackGraphSeverity;
  /** Count of nodes or edges on the path with runtime evidence */
