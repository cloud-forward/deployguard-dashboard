 ...
 */
import type { AttackGraphSeverity } from './attackGraphSeverity';
import type { AttackPathEdgeSequenceResponse } from './attackPathEdgeSequenceResponse';

export interface AttackPathDetailResponse {
  /** Stable path id */
  path_id: string;
  /** Persisted path title */
  title: string;
  /** critical | high | medium | low | none */
  risk_level: AttackGraphSeverity;
  /** Persisted normalized path risk score */
  risk_score?: number | null;
  /** Persisted raw final path risk */
  raw_final_risk?: number | null;
  /** Number of hops in the path */
  hop_count?: number;
  /** Entry point node id */
  entry_node_id?: string | null;
  /** Crown jewel / target node id */
  target_node_id?: string | null;
  /** Ordered path node ids */
  node_ids?: string[];
  /** Ordered persisted edge ids */
  edge_ids?: string[];
  /** Ordered persisted path edges */
