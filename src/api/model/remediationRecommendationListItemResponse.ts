 ...
 */
import type { RemediationRecommendationListItemResponseMetadata } from './remediationRecommendationListItemResponseMetadata';

export interface RemediationRecommendationListItemResponse {
  /** Stable recommendation id */
  recommendation_id: string;
  /** 0-based greedy selection order */
  recommendation_rank: number;
  /** Source node id for the removable edge */
  edge_source?: string | null;
  /** Target node id for the removable edge */
  edge_target?: string | null;
  /** Persisted edge type */
  edge_type?: string | null;
  /** Persisted remediation fix type */
  fix_type?: string | null;
  /** Human-readable remediation description */
  fix_description?: string | null;
  /** Persisted blocked path ids */
  blocked_path_ids?: string[];
  /** Persisted blocked path indices */
  blocked_path_indices?: number[];
  /** Persisted fix cost */
  fix_cost?: number | null;
  /** Persisted greedy edge score */
  edge_score?: number | null;
  /** Risk reduced by this recommendation alone */
  covered_risk?: number | null;
  /** Running cumulative risk reduction through this rank */
  cumulative_risk_reduction?: number | null;
  /** Persisted recommendation metadata */
  metadata?: RemediationRecommendationListItemResponseMetadata;
}
