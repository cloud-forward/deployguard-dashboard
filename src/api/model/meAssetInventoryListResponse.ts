 ...
 */
import type { MeAssetInventoryItemResponse } from './meAssetInventoryItemResponse';

export interface MeAssetInventoryListResponse {
  items?: MeAssetInventoryItemResponse[];
  total?: number;
}
