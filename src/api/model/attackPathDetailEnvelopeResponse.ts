...
export interface AttackPathDetailEnvelopeResponse {
  /** Cluster id */
  cluster_id: string;
  /** Latest analysis job id backing this path */
  analysis_run_id?: string | null;
  /** Generation timestamp for the returned path */
  generated_at?: string | null;
  /** Requested attack path detail */
  path?: AttackPathDetailResponse | null;
}
