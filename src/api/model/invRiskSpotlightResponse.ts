 ...
 */
import type { InvRiskSpotlightItem } from './invRiskSpotlightItem';

/**
 * GET /inventory/risk-spotlight 응답
 */
export interface InvRiskSpotlightResponse {
  /** 기준 graph_snapshot id. MVP: null. */
  graph_id?: string | null;
  /** [임시값] graph_nodes.is_entry_point 미연동. 빈 배열 (MVP). */
  entry_points?: InvRiskSpotlightItem[];
  /** [임시값] graph_nodes.is_crown_jewel 미연동. 빈 배열 (MVP). */
  crown_jewels?: InvRiskSpotlightItem[];
}
