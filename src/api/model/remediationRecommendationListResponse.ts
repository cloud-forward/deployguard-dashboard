...
export interface RemediationRecommendationListResponse {
  /** Cluster id */
  cluster_id: string;
  /** Latest analysis job id backing these recommendations */
  analysis_run_id?: string | null;
  /** Generation timestamp for the returned recommendations */
  generated_at?: string | null;
  items?: RemediationRecommendationListItemResponse[];
}
